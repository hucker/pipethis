...
class InputBase(ABC):
    ...
    def _list_or_string(self,items:list[str]|str|None,sep:str=" ")->list[str]:
        ...
        into a list of strings using spaces as delimiters. If the input is already a list of strings,
        ...
        if items is None or items == '':
            ...
            for item in items:
                if not isinstance(item,str):
                    msg =f"Input must be a string or a list of strings item {item} is a {type(item)}"
